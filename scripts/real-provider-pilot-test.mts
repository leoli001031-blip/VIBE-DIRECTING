...
import { buildRealProviderPilotState, realProviderPilotHardLocks } from "../src/core/realProviderPilot.ts";
...
assert(schema.$schema === "https://json-schema.org/draft/2020-12/schema", "real provider pilot schema $schema missing");
