...
import { buildRealProviderExecutorState, realProviderExecutorHardLocks } from "../src/core/realProviderExecutor.ts";
...
assert(schema.$schema === "https://json-schema.org/draft/2020-12/schema", "real provider executor schema $schema missing");
