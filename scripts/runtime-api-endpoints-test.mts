...
const expectedDefaultEndpoints = {
  ...
  currentProjectSaveProjectVibeEndpoint: "/api/runtime/projects/current/project-vibe/save",
  ...
  currentProjectSeedanceResumeEndpoint: "/api/runtime/projects/current/seedance/resume",
  ...
  runtimeDirectorTextQaEndpoint: "/api/runtime/director/text-qa",
...
const expectedCurrentProjectEndpoints = {
  ...
  currentProjectSaveProjectVibeEndpoint: expectedDefaultEndpoints.currentProjectSaveProjectVibeEndpoint,
  ...
  currentProjectSeedanceResumeEndpoint: expectedDefaultEndpoints.currentProjectSeedanceResumeEndpoint,
...

{
  ...
  assertDeepEqual(endpoints.runtimeStatusEndpoints, {
    ...
    runtimeDirectorTextQaEndpoint: expectedDefaultEndpoints.runtimeDirectorTextQaEndpoint,
...

{
  ...
  assert(currentValues.has("/api/runtime/projects/current/project-vibe/save"), "currentProjectEndpoints should include current project Project.vibe save");
  ...
  assert(currentValues.has("/api/runtime/projects/current/seedance/resume"), "currentProjectEndpoints should include Seedance resume query");
...

{
  ...
  assert(statusValues.has("/api/runtime/director/text-qa"), "runtimeStatusEndpoints should include AI director text QA");
...

{
  ...
  assert(endpoints.runtimeDirectorTextQaEndpoint === "/custom/runtime/director/text-qa", "custom director text QA mismatch");
