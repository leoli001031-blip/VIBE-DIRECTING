...
assert(schema.$schema === "https://json-schema.org/draft/2020-12/schema", "desktop runtime schema $schema missing");
...
assert(packageJson.scripts["desktop-runtime:test"] === "tsx scripts/desktop-runtime-test.mts", "package script desktop-runtime:test missing");
