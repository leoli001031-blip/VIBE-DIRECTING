...
} from "../src/core/projectFactsIntegration.ts";
import {
  addVoiceSource,
  buildVoiceSourceLibraryState,
} from "../src/core/voiceSourceLibrary.ts";
...
assert(
  projectFactsIntegrationSchema.$schema === "https://json-schema.org/draft/2020-12/schema",
  "Project Facts Integration schema $schema missing",
);
...
assert(
  packageJson.scripts["project-facts-integration:test"] === "tsx scripts/project-facts-integration-test.mts",
