...
import { buildRealProviderOneShotTestState, realProviderOneShotTestHardLocks } from "../src/core/realProviderOneShotTest.ts";
import { compileImage2OneShotRealCallPayload } from "../src/core/providerAdapters/image2Adapter.ts";
...
assert(schema.$schema === "https://json-schema.org/draft/2020-12/schema", "real provider one shot test schema $schema missing");
