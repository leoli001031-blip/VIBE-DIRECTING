...
import { buildRealExecutionGateState } from "../src/core/realExecutionGate.ts";
...
assert(schema.required.includes("schemaVersion"), "real execution gate schema must require schemaVersion");
