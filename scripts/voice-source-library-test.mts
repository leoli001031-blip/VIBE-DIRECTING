...
import { addVoiceSource, buildVoiceSourceLibraryState, markVoiceSourceStatus, toRuntimeVoiceSources, toVoiceMemoryDocument, updateVoiceSource, validateVoiceSourceLibraryState } from "../src/core/voiceSourceLibrary.ts";
...
assert(packageJson.scripts["voice-source:test"] === "tsx scripts/voice-source-library-test.mts", "package script voice-source:test missing");
