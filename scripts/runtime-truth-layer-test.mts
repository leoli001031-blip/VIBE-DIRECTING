import { buildRuntimeTruthLayer, runtimeTruthLayerSchemaVersion, transitionTaskRunLifecycle } from "../src/core/runtimeTruthLayer.ts";
...
function workerLease(overrides = {}) {
  return {
    ...
    workerId: "worker_agent_cli_mock",
