...
async function importMinimalRuntimeProjection() {
  const sourcePath = "src/core/minimalRuntimeProjection.ts";
...
const { buildMinimalRuntimeProjection, minimalRuntimeProjectionSchemaVersion } = await importMinimalRuntimeProjection();
