...
const tracedExportAction = await runExportAction({
  ...
  agentToolTrace: {
    id: "agent_tool_task_export_golden_path_001",
    inputHash: "agent_tool_input_export_golden_path_001",
    policyBinding: "director_agent_tool_handoff",
    actionId: "agent_action_export_golden_path_001",
    handoffId: "agent_tool_handoff_export_golden_path_001",
