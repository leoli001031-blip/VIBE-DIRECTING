...
checkMessage(requireWithin(agentCoreToolEventsSource, /function executionBoundaryBodyFor[\s\S]*你已经确认，我会进入执行链路/, "Execution boundary copy must explain confirmed execution state in creator language"));
