...
checkMessage(requireWithin(minimalAgentPanelSource, /id: "footer_action_new_video_draft"[\s\S]*title: "建议行动：确认这版故事"[\s\S]*toolName: "write_project"[\s\S]*确认后保存到项目/, "Ready new-video drafts must appear as an Agent confirmation message instead of a footer workflow button"));
