...
checkMessage(requireWithin(directorMode, /visibleAgentCommand[\s\S]*确认生成参考[\s\S]*确认发送视频/, "DirectorMode must adapt CreatorDesk Agent guidance to the visible execution boundary"));
