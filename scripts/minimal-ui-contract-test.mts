...
checkMessage(requireWithin(directorMode, /reviewTarget=\{directorView === "preview" \? activePreviewReviewTarget : undefined\}[\s\S]*onApproveReviewItem=\{onApproveReviewItem\}/, "DirectorMode must bind the selected preview result and existing review adapter into the Agent rail"));
