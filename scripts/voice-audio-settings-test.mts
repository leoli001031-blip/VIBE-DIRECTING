...
import { addVoiceSource, buildVoiceSourceLibraryState, toRuntimeVoiceSources } from "../src/core/voiceSourceLibrary.ts";
import { buildAudioPlanningState } from "../src/core/audioPlanning.ts";
import { buildVoiceAudioSettingsState, validateVoiceAudioSettingsState, voiceAudioSettingsHardLocks } from "../src/core/voiceAudioSettings.ts";
...
assert(packageJson.scripts["voice-audio-settings:test"] === "tsx scripts/voice-audio-settings-test.mts", "package script voice-audio-settings:test missing");
