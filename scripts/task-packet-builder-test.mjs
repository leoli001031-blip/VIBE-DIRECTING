...
assert(state.packets.length === 8, "builder must create eight task packet classes by default");
assert(state.summary.ready === 8, `all fixture packets should be ready, got ${state.summary.ready}`);
