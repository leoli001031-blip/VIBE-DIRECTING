...
checkMessage(requireWithin(appSource, /commitProjectPendingTransactionForRuntime/, "MinimalAgentPanel confirmation must stage project facts after receipt confirmation"));
