...
const videoPlanningDiagnostics = findFunctionBody(appSource, "VideoPlanningDiagnostics");
...
const motionTypeLabel = findFunctionBody(appSource, "motionTypeLabel");
const motionEndpointFactsForShot = findFunctionBody(appSource, "motionEndpointFactsForShot");
const motionContractSummaryForGate = findFunctionBody(appSource, "motionContractSummaryForGate");
const firstMotionEndpointNotice = findFunctionBody(appSource, "firstMotionEndpointNotice");
...
checkMessage(requireWithin(agentPanelProjectionSource, /commitProjectPendingTransactionForRuntime/, "MinimalAgentPanel confirmation must stage project facts after receipt confirmation"));
...
checkMessage(requireWithin(appSource, /function\s+motionTypeLabel\s*\(/, "motion endpoint label helper"));
checkMessage(requireWithin(appSource, /function\s+motionEndpointFactsForShot\s*\(/, "selected-shot motion endpoint facts helper"));
