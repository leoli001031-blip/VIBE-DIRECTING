...
import * as directorEdit from "../src/core/directorEdit.ts";
import * as taskPacketBuilder from "../src/core/taskPacketBuilder.ts";
import * as localOrchestrator from "../src/core/localOrchestrator.ts";
import * as providerLiveGate from "../src/core/providerLiveGate.ts";
import * as exportBuilder from "../src/core/exportBuilder.ts";
import * as exportWorker from "../src/core/exportWorker.ts";
import * as previewPlayerQueue from "../src/core/previewPlayerQueue.ts";
import * as visualConsistency from "../src/core/visualConsistency.ts";
...
assert(visualReport.status === "pass" || visualReport.blockers.some((b) => /MotionEndpointContract/i.test(b)), `visual consistency should pass or have expected motion endpoint blocker: ${visualReport.blockers.join("; ")}`);
