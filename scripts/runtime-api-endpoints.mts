export function createRuntimeApiEndpoints(runtimeBasePath = "/api/runtime") {
  ...
  const currentProjectSaveProjectVibeEndpoint = `${runtimeBasePath}/projects/current/project-vibe/save`;
  ...
  const currentProjectSeedanceResumeEndpoint = `${runtimeBasePath}/projects/current/seedance/resume`;
  ...
  const runtimeDirectorTextQaEndpoint = `${runtimeBasePath}/director/text-qa`;
