...
import { createProjectStoreSnapshot } from "../src/core/projectStore.ts";
import { buildProjectRuntimePlan } from "../src/core/projectRuntime.ts";
...
assert(packageJson.scripts["project-runtime:test"] === "tsx scripts/project-runtime-test.mts", "package script project-runtime:test missing");
assert(packageJson.scripts["real-provider-pilot:test"] === "tsx scripts/real-provider-pilot-test.mts", "package script real-provider-pilot:test missing");
