...
import { buildProjectFileCoreState } from "../src/core/projectFileCore.ts";
...
const importResult = spawnSync("npx", ["tsx", "scripts/import-runtime-test.mts"], {
  stdio: "inherit",
  encoding: "utf8",
  timeout: 120000,
});
...
console.log(
  `Project file core tests passed: ${projectFileCore.plannedFileTree.length} planned paths, runtime-state is ${projectFileCore.derivedCachePolicy.runtimeStateRole}.`,
);
