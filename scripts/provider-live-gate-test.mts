...
const runtimeState = readJson("fixtures/runtime-state.json");
...
assert(schema.$schema === "https://json-schema.org/draft/2020-12/schema", "provider live gate schema $schema missing");
