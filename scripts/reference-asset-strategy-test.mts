...
assert(bucket("指示灯") === "object_constraint", "indicator lights should stay scene/object details instead of standalone prop assets");
...
assert(!isStandalonePropReference("指示灯"), "indicator lights should not be uploadable as standalone prop reference");
