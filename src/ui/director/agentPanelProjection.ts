...
import type { DirectorAgentToolAvailability, DirectorAgentToolHandoff } from "../../core/directorAgentToolHandoff";
...
export function agentVideoSubmitContractForMode(mode: AgentVideoSubmitMode): AgentVideoSubmitContract {
  ...
  return videoAllowedAgentVideoSubmitContract;
}
...
export function agentVideoSubmitContractForUi(
  ...
  if (availability.videoReady) return videoAllowedAgentVideoSubmitContract;
...
export function agentVideoSubmitContractLabel(contract: AgentVideoSubmitContract) {
  ...
  if (contract.mode === "reference_allowed") return "可补参考";
  return "可发视频";
}
...
export function agentVideoSubmitContractAllowsReference(contract: AgentVideoSubmitContract) {
  return contract.referenceGenerationAllowed;
}
...
export function agentVideoSubmitContractDetail(contract: AgentVideoSubmitContract) {
  ...
  if (contract.mode === "reference_allowed") return "可以补参考，视频等你确认后再发送。";
