...
export const schemaRegistry: SchemaRegistryEntry[] = [
  ...
  {
    fileName: "provider_action_confirmation_receipt.schema.json",
    id: "https://vibecore.local/schemas/provider_action_confirmation_receipt.schema.json",
    version: schemaVersion,
  ...
  {
    fileName: "task_run_ledger.schema.json",
    id: "https://vibecore.local/schemas/task_run_ledger.schema.json",
    version: schemaVersion,
    purpose: "Append-only TaskRun runtime event ledger used as the execution source of truth for manifest, report, preview, and creator progress projections.",
    typeName: "TaskRunLedger",
  },
  {
    fileName: "artifact_transaction_gate.schema.json",
    id: "https://vibecore.local/schemas/artifact_transaction_gate.schema.json",
    version: schemaVersion,
    purpose: "Hash-bound artifact transaction gate joining output, provider observation, semantic QA, sandbox policy, and complete_verified usage summaries.",
    typeName: "ArtifactTransactionGate",
  },
  {
    fileName: "runtime_ingest_shell.schema.json",
    id: "https://vibecore.local/schemas/runtime_ingest_shell.schema.json",
    version: schemaVersion,
    purpose: "Portable runtime ingest shell for worker lease, queue, watcher, app-server, and artifact gate facts with live transports and daemons locked off.",
    typeName: "RuntimeIngestShell",
  },
  {
    fileName: "project_transaction.schema.json",
    id: "https://vibecore.local/schemas/project_transaction.schema.json",
    version: schemaVersion,
    purpose: "Pending-only Project.vibe natural-language transaction runtime with source facts, artifact invalidation, validated task enqueue, and queue ingest facts.",
    typeName: "ProjectTransactionRuntimeState",
  },
  {
  ...
  },
  {
    ...
    version: schemaVersion,
    purpose: "Post-Phase42 Image2 First real test round pilot state with provider submit, credential, worker spawn, file mutation, and Seedance/video routes locked off.",
  ...
  },
  {
    ...
    version: schemaVersion,
    purpose: "Real test round provider executor shell with budget guard, request previews, output watcher bridge plan, action-time confirmation review, and all live routes locked off.",
  ...
  },
  {
    ...
    version: schemaVersion,
    purpose: "One Creator Loop one-shot Image2 real-test gate that prepares action-time confirmation while keeping provider submission, credentials, workers, and file mutation locked off in state.",
  ...
  {
    fileName: "director_skill_definition.schema.json",
    id: "https://vibecore.local/schemas/director_skill_definition.schema.json",
    version: schemaVersion,
    purpose: "Declarative, stable-identity Director Skill v2 contract with maturity, guards, dependencies, conflicts, bounded injection, and QA checks.",
    typeName: "DirectorSkillDefinition",
  },
  {
    fileName: "director_skill_recipe.schema.json",
    id: "https://vibecore.local/schemas/director_skill_recipe.schema.json",
    version: schemaVersion,
    purpose: "Declarative compiler/provider Recipe selected by a Director Skill without execution authorization.",
    typeName: "DirectorSkillRecipe",
  },
  {
    fileName: "director_skill_case.schema.json",
    id: "https://vibecore.local/schemas/director_skill_case.schema.json",
    version: schemaVersion,
    purpose: "Fact-bound project outcome, QA evidence, and explicit human decision for one Director Skill use.",
    typeName: "DirectorSkillCase",
  },
  {
    fileName: "director_skill_invocation_receipt.schema.json",
    id: "https://vibecore.local/schemas/director_skill_invocation_receipt.schema.json",
    version: schemaVersion,
    purpose: "Fact-bound evidence for one Director Skill recommendation, selection, injection, or validation.",
    typeName: "DirectorSkillInvocationReceipt",
  },
  {
    fileName: "director_skill_invocation_ledger.schema.json",
    id: "https://vibecore.local/schemas/director_skill_invocation_ledger.schema.json",
    version: schemaVersion,
    purpose: "Project evidence sidecar for Director Skill invocation receipts, separate from current-task state.",
    typeName: "DirectorSkillInvocationLedger",
  },
  {
    fileName: "director_skill_route_result.schema.json",
    id: "https://vibecore.local/schemas/director_skill_route_result.schema.json",
    version: schemaVersion,
    purpose: "Structured Director Skill routing result with exclusions, conflicts, precedence, and context budget.",
    typeName: "DirectorSkillRouteResult",
  },
  {
    fileName: "director_skill_injection.schema.json",
    id: "https://vibecore.local/schemas/director_skill_injection.schema.json",
    version: schemaVersion,
    purpose: "Bounded Planner, Prompt Compiler, and QA injection with authorization pinned false.",
    typeName: "DirectorSkillInjection",
  },
  {
    fileName: "director_skill_qa_binding.schema.json",
    id: "https://vibecore.local/schemas/director_skill_qa_binding.schema.json",
    version: schemaVersion,
    purpose: "Hash compatibility report between Skill route, compiled prompt binding, and QA.",
    typeName: "DirectorSkillQaBindingReport",
  },
  {
    fileName: "director_skill_promotion_evaluation.schema.json",
    id: "https://vibecore.local/schemas/director_skill_promotion_evaluation.schema.json",
    version: schemaVersion,
    purpose: "Promotion eligibility report based on accepted cross-project Cases; confirmation remains separate.",
    typeName: "DirectorSkillPromotionEvaluation",
  },
  {
    fileName: "director_skill_registry_operation.schema.json",
    id: "https://vibecore.local/schemas/director_skill_registry_operation.schema.json",
    version: schemaVersion,
    purpose: "Explicitly confirmed global Skill registry operation receipt.",
    typeName: "DirectorSkillRegistryOperationReceipt",
  },
  {
    fileName: "director_skill_registry.schema.json",
    id: "https://vibecore.local/schemas/director_skill_registry.schema.json",
    version: schemaVersion,
    purpose: "Isolated user-global Skill registry with immutable versions, evidence summaries, pinning, disablement, deprecation, and rollback.",
    typeName: "DirectorSkillRegistry",
  },
  {
    fileName: "director_skill_evaluation.schema.json",
    id: "https://vibecore.local/schemas/director_skill_evaluation.schema.json",
    version: schemaVersion,
    purpose: "Fixture, routing, human-decision, QA, rollback, reuse, and trusted-evidence evaluation for the Director Skill system.",
    typeName: "DirectorSkillEvaluationReport",
  },
  {
    fileName: "director_skill_package_manifest.schema.json",
    id: "https://vibecore.local/schemas/director_skill_package_manifest.schema.json",
    version: schemaVersion,
    purpose: "Portable Director Skill package inventory with relative paths, SHA-256 integrity, dependencies, conflicts, and safety locks.",
    typeName: "DirectorSkillPackageManifest",
  },
  {
    fileName: "director_skill_portable_case.schema.json",
    id: "https://vibecore.local/schemas/director_skill_portable_case.schema.json",
    version: schemaVersion,
    purpose: "Redacted Case evidence suitable for a portable Director Skill package.",
    typeName: "DirectorSkillPortableCase",
  },
  {
    fileName: "director_skill_package_tests.schema.json",
    id: "https://vibecore.local/schemas/director_skill_package_tests.schema.json",
    version: schemaVersion,
    purpose: "Positive and negative structured Router fixtures required before an external Skill package can be enabled.",
    typeName: "DirectorSkillPackageTestSuite",
  },
  {
    fileName: "director_skill_package_import_receipt.schema.json",
    id: "https://vibecore.local/schemas/director_skill_package_import_receipt.schema.json",
    version: schemaVersion,
    purpose: "Validation and atomic publication receipt for an explicitly confirmed external Skill package import.",
    typeName: "DirectorSkillPackageImportReceipt",
  },
  {
