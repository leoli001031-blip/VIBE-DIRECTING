...
export function buildDefaultProviderRegistry(generatedAt?: string): ProviderRegistry {
  const capabilities: ProviderCapability[] = [
    ...
    capability({
      ...
      referenceImageInputRoles: ["source_start_frame", "locked_character_reference", "locked_scene_reference", "locked_style_reference", "locked_prop_reference"],
      forbiddenFallbacks: ["image2image_to_text2image", "reference_edit_to_text2image"],
      notes: ["Reference edits and end frames must derive from approved visual input; no text-to-image fallback is allowed."],
    }),
    capability({
    ...
    capability({
      ...
      referenceImageInputRoles: ["locked_character_reference", "locked_scene_reference", "locked_style_reference", "locked_prop_reference"],
    ...
    capability({
      ...
      maxReferenceImages: 4,
      referenceImageInputRoles: ["locked_character_reference", "locked_scene_reference", "locked_style_reference", "locked_prop_reference", "mask"],
      forbiddenFallbacks: ["image2image_to_text2image", "reference_edit_to_text2image"],
    ...
    capability({
      ...
      referenceImageInputRoles: [],
      forbiddenFallbacks: [],
      notes: ["Prepared local IndexTTS capability. Runtime execution must be gated by explicit permission receipt."],
    }),
    capability({
      providerId: "local-qwen3-tts-clone",
      providerName: "Local Qwen3 TTS Clone",
      slot: "audio.tts",
      requiredMode: "tts",
      executionState: "planned",
      inputKinds: ["text"],
      ...
      referenceImageInputRoles: [],
      forbiddenFallbacks: [],
      notes: ["Prepared local multilingual voice-clone capability for Qwen3-TTS Base. Runtime execution must be gated by explicit permission receipt and reference-audio consent."],
    }),
    capability({
      ...
      referenceImageInputRoles: [],
      forbiddenFallbacks: [],
      notes: ["Prepared cloud TTS capability. Vendor selection and API key stay in runtime configuration."],
    }),
    capability({
  ...
  return {
    ...
    defaultProviderBySlot: {
      ...
      "audio.tts": "local-qwen3-tts-clone",
